function Services() {
  ...
  return (
    <div className="px-28 py-8 flex flex-col items-center justify-center">
      <h2 className="text-4xl font-semibold">
        What Services we provide to out customers.
      </h2>
      ...
      <div className="flex justify-center items-center gap-2 mt-14">
        {services.map((service, index) => (
          <div
            key={index}
            className="flex h-52 w-1/3 flex-col gap-6 bg-white"
          >
